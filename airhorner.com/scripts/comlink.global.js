...
self.Comlink = (function () {
    ...
    // proxyâ€™d, we need to set some sort of transferable, secret marker. This is it.
    ...
    function attachMessageHandler(endpoint, f) {
        // Checking all possible types of `endpoint` manually satisfies TypeScriptâ€™s
        // type checker. Not sure why the inference is failing here. Since itâ€™s
        // unnecessary code Iâ€™m going to resort to `any` for now.
